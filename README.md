# shufflingproject
his project is a simple HTML, CSS, and JavaScript web page that displays a list of people assigned to various rooms and beds. The main feature of this webpage is a "Shuffle" button that randomizes the names within the list while keeping the room and bed assignments static.
...
View the list of people assigned to various rooms and beds.
Click the "Shuffle" button to randomize the names within the list.
